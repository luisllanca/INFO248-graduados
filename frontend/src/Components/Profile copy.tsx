...
const Profile: React.FC = () => {
  ...
  const getEmail = async () => {
    ...
    fetch(`https://dev-lpmhwti1uwtsgfok.us.auth0.com/api/v2/users-by-email?email=${correo}`, requestOptions)
  ...
  const login = async () => {
    try {
      const response = await axios.post("http://localhost:8080/user/login", { correo});
  ...
  const getRoles = async (userId: string)  => {
    ...
    fetch(`https://dev-lpmhwti1uwtsgfok.us.auth0.com/api/v2/users/${userId}/roles`, requestOptions)
      .then(response => response.json())
      .then(result => {
