...
REPLACE INTO `becas` (`id`, `tipo`, `monto`, `fechaAsi`, `fechaExp`, `descripcion`, `id_estudiante`) VALUES
	(1, 'gratuidad', 100, '2023-05-15 18:32:03', '2023-05-15 18:32:07', 'Beca gratiudad cubre la matricula y el arancel mientra es vigente.', 1),
	(2, 'Profesores', 100, '2023-05-15 18:32:03', '2023-05-15 18:32:07', 'Beca por ser hijo de profesor cubre un porncetaje de la matricula y el arancel.', 2),
	(3, 'gratuidad', 100, '2023-05-15 18:32:03', '2023-05-15 18:32:07', 'Beca gratiudad cubre la matricula y el arancel mientra es vigente.', 3);
...
-- Volcando datos para la tabla egresados.usuarios: ~4 rows (aproximadamente)
REPLACE INTO `usuarios` (`id`, `nombre`, `apellido`, `password`, `email`) VALUES
	(1, 'matias', 'martinez', 'holaa1231', 'matias.martinez@correo.cl'),
